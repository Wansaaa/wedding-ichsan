        ...
        <div className="flex flex-col gap-4 w-full z-10">
          ...
          <div className="flex flex-col items-center sm:flex-row sm:justify-start group">
            <div className="relative">
              <img src="https://placehold.co/300x300?text=Foto Pria" alt="pengantin pria" className="w-24 md:w-28 rounded-full border-4 border-white/20 shadow-xl transition-transform duration-500 group-hover:scale-105" />
            </div>
          ...
          <div className="flex flex-col items-center sm:flex-row-reverse sm:text-right group">
            <div className="relative">
              <img src="https://placehold.co/300x300?text=Foto Wanita" alt="pengantin wanita" className="w-24 md:w-28 rounded-full border-4 border-white/20 shadow-xl transition-transform duration-500 group-hover:scale-105" />
            </div>
